...
To run the experiments for actively estimating the mutual information of a single feature, follow the instructions in the README.txt file in the "single" folder.
To run the experiments for active feature selection, follow the instructions in the README.txt file in the "afs" folder.
