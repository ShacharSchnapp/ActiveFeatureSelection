...
svm_active by going through a simple active learning task with clear
descriptions.
"""
...
from svm_active.query_strategies import RandomSampling, UncertaintySampling
from svm_active.labelers import IdealLabeler
...
def run(trn_ds, tst_ds, lbr, model, qs, quota):
    ...
    for _ in range(quota):
        # Standard usage of svm_active objects
