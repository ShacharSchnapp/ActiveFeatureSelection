...
class ActiveLearningByLearning(QueryStrategy):
    ...
    query_strategies : list of :py:mod:`svm_active.query_strategies`\
    object instance
    ...
    model : :py:mod:`svm_active.models` object instance
    ...
    Attributes
    ----------
    query_strategies\_ : list of :py:mod:`svm_active.query_strategies` object instance
    ...
    .. code-block:: python
       ...
       from svm_active.query_strategies import ActiveLearningByLearning
       from svm_active.query_strategies import HintSVM
    ...
    :code:`svm_active.query_strategies` object instances where each of their
...
class Exp4P(object):
    ...
    query_models\_ : list of :py:mod:`svm_active.query_strategies` object instance
