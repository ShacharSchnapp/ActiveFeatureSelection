...
from baselines.svm_active.base.interfaces import QueryStrategy, ProbabilisticModel
import baselines.svm_active.models
from baselines.svm_active.utils import inherit_docstring_from, seed_random_state
...
class QueryByCommittee(QueryStrategy):
    ...
    Parameters
    ----------
    models : list of :py:mod:`svm_active.models` instances or str
        This parameter accepts a list of initialized svm_active Model instances,
        or class names of svm_active Model classes to determine the models to be
    ...
    .. code-block:: python
       ...
       from svm_active.query_strategies import QueryByCommittee
    ...
    def __init__(self, *args, **kwargs):
        ...
        for model in models:
            if isinstance(model, str):
                self.students.append(getattr(baselines.svm_active.models, model)())
            else:
