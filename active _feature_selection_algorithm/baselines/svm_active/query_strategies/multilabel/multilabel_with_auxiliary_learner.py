...
class MultilabelWithAuxiliaryLearner(QueryStrategy):
    ...
    Parameters
    ----------
    major_learner : :py:mod:`svm_active.base.interfaces.Model` object instance
        The major multilabel learner. This learner should be the model to be
        used to solve the problem.

    auxiliary_learner : :py:mod:`svm_active.models.multilabel` object instance
    ...
    .. code-block:: python
       ...
       from svm_active.query_strategies.multilabel import MultilabelWithAuxiliaryLearner
       from svm_active.models.multilabel import BinaryRelevance
       from svm_active.models import LogisticRegression, SVM
