...
from svm_active.base.interfaces import QueryStrategy, ProbabilisticModel
...
class EER(QueryStrategy):
    ...
    Parameters
    ----------
    model: :py:class:`svm_active.base.interfaces.ProbabilisticModel` object instance
    ...
    .. code-block:: python
       ...
       from svm_active.query_strategies import EER
